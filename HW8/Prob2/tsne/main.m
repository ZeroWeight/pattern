...
load ../trainY.txt
load ../testY.txt
TrainX_tsne=tsne(trainX,[]);
TestX_tsne=tsne(testX,[]);

X0=TrainX_tsne(trainY==0,:);
X1=TrainX_tsne(trainY==1,:);
X2=TrainX_tsne(trainY==2,:);
X3=TrainX_tsne(trainY==3,:);
X4=TrainX_tsne(trainY==4,:);
